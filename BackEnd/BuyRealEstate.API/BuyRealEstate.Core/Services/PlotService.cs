    ...
    public class PlotService : IPlotService
    {
        ...
        public async Task<IEnumerable<PlotDTO>> GetAllPlotsAsync()
        {
            ...
            return plots.Select(p => new PlotDTO
            {
                ...
                {
                    ID = p.Project.ID,
                    GrossProfit = p.Project.GrossProfit,
                    //Documents =new DocumentDTO{
                    // DocumentData =  p.Project.Documents,
                    //DocumentDescription = p.Project.Documents[0].Description
                    // },
                    //  PaymentProject = p.Project.PaymentProject,
                    //DeveloperStatus = p.Project.DeveloperStatus,
                    //Images = p.Project.Images,
                    //LegalStatus = p.Project.LegalStatus,
                    LinkToYad2 = p.Project.LinkToLead2,
                    ProjectAddress = p.Project.ProjectAddress,
                    // ProjectManager = p.Project.ProjectManager,
