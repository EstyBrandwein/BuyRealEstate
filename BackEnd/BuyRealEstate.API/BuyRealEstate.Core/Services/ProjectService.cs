...
namespace BuyRealEstate.Core.Services
{
    public class ProjectService : IProjectService
    {
        ...
        public async Task<IEnumerable<ProjectDTO>> GetAllProjectsAsync()
        {
            ...
            {
                //Id = p.ID,
                Documents = (ICollection<Common.DTos.DocumentDTO>)p.Documents,
                DeveloperStatus = (ICollection<Common.DTos.DevelopmentStatusDTO>)p.DeveloperStatus,
                GrossProfit = p.GrossProfit,
                Images = (ICollection<Common.DTos.ImageDTO>)p.Images,
                LegalStatus = (ICollection<Common.DTos.LegalStatusDTO>)p.LegalStatus,
                LinkToYad2 = p.LinkToLead2,
                PaymentProject = (ICollection<Common.DTos.RelationshipPaymentsProjectsDTO>)p.PaymentProject,
                ProjectAddress = p.ProjectAddress,
                //ProjectManager = (Common.DTos.UsersDTO)p.ProjectManager,
