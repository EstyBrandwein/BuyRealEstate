...
namespace BuyRealEstate.Domain.Extensions
{
    public static class EntityFrameworkExtensions
    {
        public static void AddMockData(this ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DevelopmentStatus>().HasData(
                   new DevelopmentStatus { Status = "הפיתוח בעיצומו", Id = 1, InsertDate = DateTime.Now, UpdateDate = DateTime.Now, State = true, InsertUser = 1, UpdateUser = 1 },
                   new DevelopmentStatus { Status = "הפיתוח הושלם", Id = 2, InsertDate = DateTime.Now, UpdateDate = DateTime.Now, State = true, InsertUser = 1, UpdateUser = 1 }
                 );
