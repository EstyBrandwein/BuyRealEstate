...
namespace BuyRealEstate.Domain.Migrations
{
    ...
    [Migration("20241212133751_AddData")]
            ...
            modelBuilder.Entity("BuyRealEstate.Domain.Models.PaymentStatus", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            InsertDate = new DateTime(2024, 12, 12, 15, 37, 50, 806, DateTimeKind.Local).AddTicks(4029),
                            InsertUser = 1,
                            State = true,
                            Status = "לא שולם",
                            UpdateDate = new DateTime(2024, 12, 12, 15, 37, 50, 807, DateTimeKind.Local).AddTicks(6560),
                            UpdateUser = 1
                        },
                        new
                        {
                            Id = 2,
                            InsertDate = new DateTime(2024, 12, 12, 15, 37, 50, 807, DateTimeKind.Local).AddTicks(7058),
                            InsertUser = 1,
                            State = true,
                            Status = "מחכה לאישור",
                            UpdateDate = new DateTime(2024, 12, 12, 15, 37, 50, 807, DateTimeKind.Local).AddTicks(7062),
                            UpdateUser = 1
                        },
                        new
                        {
                            Id = 3,
                            InsertDate = new DateTime(2024, 12, 12, 15, 37, 50, 807, DateTimeKind.Local).AddTicks(7064),
                            InsertUser = 1,
                            State = true,
                            Status = "שולם",
                            UpdateDate = new DateTime(2024, 12, 12, 15, 37, 50, 807, DateTimeKind.Local).AddTicks(7065),
                            UpdateUser = 1
                        });
                });
            ...
            modelBuilder.Entity("BuyRealEstate.Domain.Models.Users", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FirstName = "חיה",
                            InsertDate = new DateTime(2024, 12, 12, 15, 37, 50, 808, DateTimeKind.Local).AddTicks(1188),
                            InsertUser = 1,
                            LastName = "ברנדויין",
                            Password = "cb5328152",
                            PermissionId = 1,
                            Phone = "0504101585",
                            State = true,
                            UpdateDate = new DateTime(2024, 12, 12, 15, 37, 50, 808, DateTimeKind.Local).AddTicks(1196),
                            UpdateUser = 1,
                            Username = "ChayaBrandwian"
                        },
                        new
                        {
                            ID = 2,
                            Email = "nihul@efshar-nadlan.co.il",
                            FirstName = "ברכה",
                            InsertDate = new DateTime(2024, 12, 12, 15, 37, 50, 808, DateTimeKind.Local).AddTicks(1340),
                            InsertUser = 1,
                            LastName = "וינבאום",
                            Password = "BrachaVinbaum",
                            PermissionId = 1,
                            Phone = "0527648861",
                            State = true,
                            UpdateDate = new DateTime(2024, 12, 12, 15, 37, 50, 808, DateTimeKind.Local).AddTicks(1342),
                            UpdateUser = 1,
                            Username = "ChayaBrandwian"
                        });
                });
